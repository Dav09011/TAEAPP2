...
/// Admin registration screen kept in the legacy tree while auth logic migrates.
///
/// This screen now delegates account creation to `RegisterAccountController`.
/// The UI still owns form layout and post-success navigation only.
    ...
    try {
      await _controller.register(
        RegistrationRequest(
          ...
          role: 'admin',
          profileCategory: 'instructor_admin',
        ),
      );
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Administrador registrado con exito.')),
      );
      Navigator.pushNamed(context, AppRoutes.licenseSelection);
